...
<template>
  <div ref="containerRef" :style="style"
    class="fixed  w-[300px] h-[200px] rounded-lg border border-gray-200 bg-white shadow-lg overflow-hidden">
    <div ref="dragHandleRef" class="flex group justify-center items-center h-6 cursor-move  "
      @pointerdown.prevent="onDragPointerDown">
      <div
        class="h-1 w-16 rounded-full bg-gray-400/80  select-none touch-none group-hover:bg-gray-500 transition-colors" />
      <slot />
    </div>
