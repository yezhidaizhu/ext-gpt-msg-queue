...
<template>
  <div ref="containerRef" :style="style"
    ...
    <div ref="dragHandleRef"
      ...
      <!-- 左上角按钮 -->
      <div class="absolute left-2 flex group items-center gap-1.5 cursor-auto text-black" style="--btn-size:15px"
        @pointerdown.stop>
        <!-- close -->
        ...
        <span class="relative flex size-[var(--btn-size)] items-center justify-center rounded-full bg-yellow-400"
          @click="$emit('mini-win')">
          <svg class="hidden size-3 group-hover:block" viewBox="0 0 8 8"  aria-hidden="true">
